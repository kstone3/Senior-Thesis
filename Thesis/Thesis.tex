...
\begin{figure}[h!]
    \centering
    \makebox[0pt][c]{\includegraphics[width=0.8\paperwidth]{Plots/oggm_vs_calculated.png}}
...
% \textbf{Add paragraph about sia model performing well}
...
% The simple SIA-Mass Balance model used by this study is able to model the runoff from a single glaciated mountain basin with somewhat limited accuracy 
% on monthly timescales and much better accuracy on yearly and decadal timescales. It performs much better than the more advanced OGGM model likely due 
% to the SIA-Mass Balance model being tuned to the local climate of the glacier and using real-world temperature and precipitation data.
\section*{Appendix}
\begin{table}[h!]
    \centering
    \begin{tabular}{|c|c|c|}
