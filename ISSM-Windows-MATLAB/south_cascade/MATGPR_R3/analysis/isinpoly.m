...
%
% ISINPOLY : Finds whether points with coordinates X and Y are inside or
% outside of a polygon with vertices XP, YP.
%
% Usage: 
% isin = isinpoly(x,y,xp,yp)
%
% Output:
% Returns matrix ISIN of the same size as X and Y with 0 for points outside
% a polygon, 1 for inside points and  0.5 for points belonging to a polygon
% XP, YP itself. 
%
...
% Handle input
if nargin<4
  disp('ISINPOLY > Error: not enough input arguments')
  return
end
